...
interface UnidadeRankingProps {
  data: RankingItem[];
}

export const UnidadeRanking = ({ data }: UnidadeRankingProps) => {
    ...
    <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 shadow-sm">
      <CardHeader className="pb-2 border-b border-slate-100 dark:border-slate-800">
        <CardTitle className="text-sm font-black uppercase tracking-wider text-slate-700 dark:text-slate-300">
          Top Unidades por Custo de Pool
        </CardTitle>
      </CardHeader>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-slate-100 dark:border-slate-800 hover:bg-transparent">
                <TableHead className="text-[10px] font-black uppercase text-slate-500 tracking-wider">Unidade / C.Custo</TableHead>
