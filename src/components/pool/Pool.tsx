  ...
  if (isError) {
    return (
      <div className="p-12 text-center space-y-4">
        ...
        <h3 className="text-lg font-black text-slate-800 dark:text-white uppercase tracking-wider">Erro ao carregar dados do POOL</h3>
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-5">
        <div>
          <h1 className="text-2xl font-black uppercase tracking-tight text-slate-800 dark:text-white flex items-center gap-2">
            <Car className="h-7 w-7 text-indigo-600 dark:text-indigo-400" />
            Painel Geral do POOL de Veículos
          </h1>
          <p className="text-xs text-slate-500 font-medium mt-1">
            Análise consolidada de agendamentos, custos operacionais, consumo e rankings de utilização do Pool
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 shadow-sm">
              <CardHeader className="pb-2 border-b border-slate-100 dark:border-slate-800">
                ...
                <CardDescription className="text-[11px] font-medium text-slate-500">
                  Total de despesas do Pool acumuladas mês a mês
                </CardDescription>
              </CardHeader>
            ...
            <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 shadow-sm">
              <CardHeader className="pb-2 border-b border-slate-100 dark:border-slate-800">
                ...
                <CardDescription className="text-[11px] font-medium text-slate-500">
                  Quantidade total de corridas agendadas e efetuadas por mês
                </CardDescription>
              </CardHeader>
              <CardContent className="p-4 h-80">
                <ResponsiveContainer width="100%" height="100%">
