  ...
  const handleSendEmail = (gerencia: string, vehicles: any[]) => {
    ...
    const abastData = relevantTxs.map(f => {
      ...
      return {
        ...
        "Km Rodados ou Horas Trabalhadas": parseBrazilianNumber(f["KM RODADOS OU HORAS TRABALHADAS"] || raw[17] || f.COL_17 || raw[39] || f.COL_39 || f._kmRodados || 0),
        "Valor Emissão": parseBrazilianNumber(f["VALOR EMISSAO"] || raw[24] || f.COL_24 || f._total || 0),
